document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateElementPosition(element, event) {
        ...
        const elementY = parseInt(element.style.top || window.innerHeight / 2) + movementY;
        const elementX = parseInt(element.style.left || window.innerWidth / 2) + movementX;
        ...
        pointers[0].dx = movementX * 10.0;
        pointers[0].dy = movementY * 10.0;
        pointers[0].x = elementX;
        pointers[0].y = elementY;
    }
